    ...
    <nav data-role="Header" className={`navbar-navbar ${props.rootClassName} `}>
      ...
      <div className="navbar-right-side">
        <div className="navbar-links-container">
          ...
          <button className="navbar-button button">{props.button}</button>
          <button className="navbar-button1 button">{props.button1}</button>
        </div>
      </div>
      ...
      <div data-type="MobileMenu" className="navbar-mobile-menu">
        <div className="navbar-nav">
          ...
          <div className="navbar-right-side1">
            <div className="navbar-links-container1">
              ...
              <span className="navbar-text5">{props.text6}</span>
              <span className="navbar-text6">{props.text7}</span>
        ...
        <div className="navbar-follow-container">
          <span className="navbar-text8">{props.text4}</span>
